...
#[async_recursion]
pub async fn get(route: Route<ServerState>, auth: Authorization) -> ApiResponse {
...
#[async_recursion]
pub async fn post(route: Route<ServerState>, auth: Authorization, user_id: Snowflake) -> ApiResponse {
...
#[async_recursion]
pub async fn del(route: Route<ServerState>, auth: Authorization, user_id: Snowflake) -> ApiResponse {
