...
#[inline]
pub fn nonce_from_user_id(user_id: Snowflake) -> Nonce {
...
pub fn encrypt_user_message(key: &Key<Aes256GcmSiv>, user_id: Snowflake, plaintext: &[u8]) -> Vec<u8> {
...
pub fn decrypt_user_message(key: &Key<Aes256GcmSiv>, user_id: Snowflake, ciphertext: &[u8]) -> Option<Vec<u8>> {
