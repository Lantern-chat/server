...
lazy_static::lazy_static! {
    ...
    pub static ref EVENT_CODE: Type = <EventCode as EnumType>::ty(26744);
}
...
thorn::tables! {
    ...
    pub struct Messages in Lantern {
        ...
        Embeds: Nullable(Type::JSONB),
        /// denormalized array of pin-tag IDs
        PinTags: Nullable(Type::INT8_ARRAY),
        /// denormalized array of users who have starred this message
        StarredBy: Nullable(Type::INT8_ARRAY),
    }
