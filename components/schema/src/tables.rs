...
thorn::functions! {
    ...
    pub extern "pg" fn iif(condition: Type::BOOL, true_result: Type::ANYELEMENT, false_result: Type::ANYELEMENT) in Lantern;
...
pub static EVENT_CODE: std::sync::LazyLock<Type> = std::sync::LazyLock::new(|| <EventCode as thorn::EnumType>::ty(23239));
...
thorn::tables! {
    ...
    pub struct Config in Lantern {
        ConfigId: Type::UUID,
        ConfigName: Type::TEXT,
        LastUpdated: Type::TIMESTAMPTZ,
        ServerName: Type::TEXT,
        BaseDomain: Type::TEXT,
        CdnDomain: Type::TEXT,
        StrictCdn: Type::BOOL,
        SecureWeb: Type::BOOL,
        CamoEnable: Type::BOOL,
        FsCacheInterval: Type::INT8,
        FsCacheMaxAge: Type::INT8,
        SessionDuration: Type::INT8,
        MinimumAge: Type::INT2,
        PasswordLength: Type::INT4_RANGE,
        UsernameLength: Type::INT4_RANGE,
        MfaBackupCount: Type::INT2,
        MfaPendingTime: Type::INT8,
        RegistrationToken: Nullable(Type::TEXT),
        ReltimeRndFactor: Type::FLOAT4,
        MaxStatusLen: Type::INT2,
        MaxBioLen: Type::INT2,
        PresenceTimeout: Type::INT8,
        PartyNameLen: Type::INT4_RANGE,
        PartyDescLen: Type::INT4_RANGE,
        RoomNameLen: Type::INT4_RANGE,
        RoomTopicLen: Type::INT4_RANGE,
        RoleNameLen: Type::INT4_RANGE,
        RoleDescLen: Type::INT4_RANGE,
        MaxActiveRooms: Type::INT2,
        MaxTotalRooms: Type::INT2,
        MaxNewlines: Type::INT2,
        MessageLength: Type::INT4_RANGE,
        MaxEmbeds: Type::INT2,
        RegexSearchLen: Type::INT2,
        MaxUploadSize: Type::INT8,
        MaxUploadChunk: Type::INT4,
        OrphanCleanup: Type::INT8,
        MaxAvatarSize: Type::INT4,
        MaxBannerSize: Type::INT4,
        AvatarWidth: Type::INT4,
        BannerWidth: Type::INT4,
        BannerHeight: Type::INT4,
        MaxAvatarPixels: Type::INT4,
        MaxBannerPixels: Type::INT4,
        HcaptchaSecret: Type::BPCHAR,
        HcaptchaSitekey: Type::BPCHAR,
        B2App: Nullable(Type::TEXT),
        B2Key: Nullable(Type::TEXT),
        EmbedWorkerUris: Nullable(Type::TEXT_ARRAY),
    }
    ...
    pub struct FactionParties in Lantern {
        FactionId: Type::UUID,
        PartyId: Type::INT8,
    }

    pub struct Factions in Lantern {
        Id: Type::UUID,
        Addr: Type::INET,
        Nickname: Nullable(Type::TEXT),
    }
    ...
    pub struct Files in Lantern {
        ...
        Name: Type::BYTEA,
        B2FileId: Nullable(Type::BYTEA),
        /// SHA-1 hash of completed file
        Sha1: Nullable(Type::BYTEA),
        Blake3: Nullable(Type::BYTEA),
