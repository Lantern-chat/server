...
pub static EVENT_CODE: LazyLock<Type> = LazyLock::new(|| <EventCode as EnumType>::ty(26410));

thorn::tables! {
    pub struct Configs in Lantern {
        ConfigId:           Type::UUID,
        ...
        HcaptchaSecret:     Nullable(Type::BPCHAR), //char(42),
        HcaptchaSitekey:    Nullable(Type::BPCHAR), //char(32),
