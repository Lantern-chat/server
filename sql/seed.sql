...
COMMENT ON COLUMN lantern.messages.pin_tags IS 'denormalized array of pin-tag IDs';
COMMENT ON COLUMN lantern.messages.starred_by IS 'denormalized array of users who have starred this message';
COMMENT ON COLUMN lantern.messages.embeds IS 'JSONB Array of embed structures';
