...
CREATE INDEX CONCURRENTLY overrides_room_role_idx ON lantern.overrides USING hash(room_id, role_id);
CREATE INDEX CONCURRENTLY overrides_room_user_idx ON lantern.overrides USING hash(room_id, user_id);
