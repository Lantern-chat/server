ALTER TABLE IF EXISTS lantern.thread_subscriptions DROP CONSTRAINT IF EXISTS thread_fk CASCADE;
ALTER TABLE IF EXISTS lantern.thread_subscriptions DROP CONSTRAINT IF EXISTS user_fk CASCADE;
